...
def main():
    ...
    for route in routes:
        ...
        route_key = (target_key, route_id)
        require(target_key and route_id and route_key not in route_ids,
                "route id must be present and unique within its target")
    ...
    for schedule in test_schedules:
        ...
        require(target_key, "test schedule missing target_key")
        ...
        for case in cases:
            ...
            require((target_key, case.get("expected_route_id")) in route_ids,
                    f"test case {case_id} references unknown route")
